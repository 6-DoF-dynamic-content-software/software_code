...
VIEWS = 80 #num views to generate
RESOLUTION = 800
DEPTH_SCALE = 1.4
COLOR_DEPTH = 8
FORMAT = 'PNG'
...
ply_path = "/home/jackzhu/Downloads/dataset_test/longdress/" #Folder for all ply files
...
for file in files[:]:
    ...
    print(name)
    fp = "/home/jackzhu/Downloads/longdress/" + name
