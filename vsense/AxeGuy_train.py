...
def initialization(mesh_path,file):
    ...
    model.rotation_euler = (math.pi*163/180, -math.pi*48/180, -math.pi*71/180)
...
ply_path = "/home/jackzhu/Downloads/dataset_test/AxeGuy_ply_400K/"
files = os.listdir(ply_path)
files.sort()
for file in files[:]:
    file_path = ply_path + file
    name = get_name(file) + '_train/'
    fp = "/home/jackzhu/Downloads/AxeGuy_train/" + name
