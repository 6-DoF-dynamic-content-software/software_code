...
def initialization(mesh_path,file):
    ...
    model.rotation_euler = (math.pi*90/180, -math.pi*90/180, 0)
...
ply_path = "/home/jackzhu/Downloads/dataset_test/LubnaFriends_ply_400K/"
...
for file in files[:]:
    ...
    fp = "/home/jackzhu/Downloads/Lubna_train/" + name 
