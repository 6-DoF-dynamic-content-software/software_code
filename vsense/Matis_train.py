...
def initialization(mesh_path,file):
    ...
    model.rotation_euler = (-math.pi*90/180, math.pi*100/180, 0)
...
ply_path = "/home/jackzhu/Downloads/dataset_test/Matis_ply_400K/"
files = os.listdir(ply_path)
files.sort()
for file in files[:]:
    file_path = ply_path + file
    name = get_name(file) + '_train/'
    fp = "/home/jackzhu/Downloads/vsense/Matis_train/" + name
